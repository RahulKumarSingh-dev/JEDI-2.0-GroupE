...
private List<Course> viewCourse(String studentId){
	...
	System.out.println(String.format("%-20s %-20s %-20s %-20s %-20s","COURSE CODE", "COURSE NAME", "INSTRUCTOR", "SEATS", "FEES"));
	for(Course obj : course_available)
	{
		System.out.println(String.format("%-20s %-20s %-20s %-20s %-20s",obj.getCourseCode(), obj.getCourseName(),obj.getInstructorId(), obj.getSeats(), obj.getFees()));
	}
